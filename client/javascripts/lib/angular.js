 ...
 *
 * Note that ngScenario-based end-to-end spec cannot use this function to bootstrap manually.
 ...
 *
 * For spec we provide {@link ngMock.$browser mock implementation} of the `$browser`
...
function Browser(window, document, $log, $sniffer) {
  ...
  self.notifyWhenNoOutstandingRequests = function(callback) {
    ...
    // regular poller would result in flaky spec.
   ...
   * `setTimeout` in spec, the fns are queued in an array, which can be programmatically flushed
 ...
 * the browser console.
 * 
 * In unit spec, if `angular-mocks.js` is loaded, this service is overridden by
...
function $IntervalProvider() {
  this.$get = ['$rootScope', '$window', '$q',
    ...
    var intervals = {};
      ...
      *
      * In spec you can use {@link ngMock.$interval#methods_flush `$interval.flush(millis)`} to
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       *
       * In unit spec, you may need to call `$digest()` to simulate the scope life cycle.
       *
       * # Example
       * <pre>
           var scope = ...;
      ...
      $digest: function() {
        ...
        do { // "while dirty" loop
          ...
          do { // "traverse the scopes" loop
            ...
            // yes, this code is a bit crazy, but it works and we have spec to prove it!
...
function $TimeoutProvider() {
  this.$get = ['$rootScope', '$browser', '$q', '$exceptionHandler',
    ...
    var deferreds = {};
      ...
      *
      * In spec you can use {@link ngMock.$timeout `$timeout.flush()`} to
...
// cause us to break spec.  In addition, when the browser resolves a URL for XHR, it
